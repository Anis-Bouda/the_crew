...
public class BJK_ig extends AbstractComponent6 {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawString("T", x + 30, y - headerHeight + 35);
        ...
        g2.drawString("S", x + 55, y - headerHeight + 30);
        g2.drawString("R", x + 55, y - headerHeight + 85);
     ...
     // Dessiner un cercle vide de diamètre 20 centré à (x, y - headerHeight + 65)
        ...
        g2.drawLine(x+20, y - headerHeight + 70, x , y - headerHeight + 70); // Deuxième ligne droite
