public class PullResistor extends Composant {
	        ...
	        if (this.inputs.size() == 1 && this.outputs.size() == 1) {
	           // on recupere les inputs 
	        	  ...
	        	  if(inputs == State.ERROR) {
	        		  ...
	        		  // si l'entree c'est 0 ou 1, le sortie c'est l'entree
	        		  outputs= inputs;
	        	}
    ...
    public boolean equals(Object obj) {
        ...
        PullResistor objet = (PullResistor) obj;
        return this.pullState==objet.pullState;
    }

    @Override
    public String toString() {
        return super.toString() + ", Pullstate :" + this.pullState;
    }

    @Override
    public int hashCode() {
        int res=super.hashCode();
        res=res *71 + this.pullState.hashCode();
        return res;
    }
}