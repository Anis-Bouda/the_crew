...
public class BitFINDER extends Composant{
    ...
    BitFINDER objet = (BitFINDER) obj;
    return this.n == objet.n && this.index == objet.index;
    }

    @Override
    public int hashCode() {
     int result = super.hashCode();
     result = 17 * result + this.n;
     result = 17 * result + this.index;
     return result;
    }

   @Override
    public String toString() {
     return super.toString() + ", n=" + this.n + ", index=" + this.index;
  }
}