...
public class BitFinder_ig extends AbstractComponent {
    ...
    public BitFinder_ig() {
        ...
        setOpaque(false);
         ...
         BitFINDER bitFlogique = new BitFINDER(TOOL_TIP_TEXT_KEY, WHEN_ANCESTOR_OF_FOCUSED_COMPONENT, UNDEFINED_CONDITION, ABORT, offsetY);
