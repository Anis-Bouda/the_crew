...
public class Multiplier extends AbstractComponent {
    ...
    public Multiplier() {
        super("MULTIPLIER", 2, 1);
        setOpaque(false);

         /*la création de la porte logique pour le liens  */
        MULTPLAY Multiplayerlogique = new MULTPLAY(TOOL_TIP_TEXT_KEY, UNDEFINED_CONDITION, ABORT, offsetY);
        setComposant(Multiplayerlogique);
