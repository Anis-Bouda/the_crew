...
public abstract class AbstractComponent4 extends AbstractComponent { 
    ...
    protected void updatePortPositions() {
        ...
        inputPorts.add(new java.awt.Point(xPos2, yPos2));
        ...
        for (int i = 3; i < numInputs; i++) {
            ...
            inputPorts.add(new java.awt.Point(xPos3, yPos3));
        }

        // Positionner les ports de sortie (output)
        for (int i = 0; i < 2; i++) {
            int xPos = 270;  // Tous les ports de sortie sont à gauche (x = 0)
            int yPos = 60;  // Positionner les ports de sortie en bas à gauche
