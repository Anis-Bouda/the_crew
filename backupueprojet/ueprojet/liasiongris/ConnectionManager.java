...
public class ConnectionManager {
    ...
    public static void portClicked(AbstractComponent comp, String portType, int portIndex, Point globalPoint) {
		...
		/*le fil logique*/
		String id = "Fil_" + connections.size();
		Fil fil = new Fil(id, srcLogic, dstLogic, inputIndex, outputIndex);
		/*le fil graphique*/
		Wire wire = new Wire(selectedComponent, comp);
		switch (fil.getValue()) 
		{
    			case True:
