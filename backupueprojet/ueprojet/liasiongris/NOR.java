public class NOR extends Composant {
    ...
    private OR ouGate;  /*La sous-porte OU du NOR*/
    private NOT nonGate; /*La sous-porte NON du NOR*/
    ...
    public NOR(String id, int x,int y)
    {
        ...
        this.ouGate = new OR("NOR_OU", x,y);
        this.nonGate = new NOT("NOR_NON", x,y);
    }
    ...
    public void evaluate()
    {
        if (this.inputs.size() == 2 && this.outputs.size()==1)
        {
            ...
            System.out.println("💡 NOR " + id + " inputs = " + inputs);
            State output;
            ...
            this.state=output;
            System.out.println("💡 NOR " + id + " outputs = " + outputs);
        }
        else
        {
