public class NAND extends Composant {
    ...
    private NOT nonGate; /*La sous-porte NON du NAND*/
    ...
    public NAND(String id, int x,int y)
    {
        ...
        this.nonGate = new NOT("NAND_NON", x,y);
    }
    ...
    public void evaluate()
    {
        if (this.inputs.size() == 2 && this.outputs.size()==1)
        {
            ...
            System.out.println("💡 NAND " + id + " inputs = " + inputs);
            State output;
            ...
            this.state=output;
            System.out.println("💡 NAND " + id + " outputs = " + outputs);
        }
        else
        {
