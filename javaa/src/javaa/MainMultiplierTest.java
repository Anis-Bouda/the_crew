...
public class MainMultiplierTest {
    public static void main(String[] args) {
        // un mot de 4 bits 
    	// on veut affiche le bit positionner a l'index = 2
    	Multiplier model = new Multiplier("Multiplier1", 100, 100);
        ...
        Multiplier_ig view = new Multiplier_ig();
        ...
        MultiplierController controller = new MultiplierController(model, view);
