...
public class TestMULTPLAY {
    public static void main(String[] args) {
        testMultiplication(2, new State[]{State.True, State.False, State.True, State.True}, "Multiplication 3 × 3");  // 3 * 3 = 9 (1001)
        testMultiplication(2, new State[]{State.False, State.False, State.True, State.True}, "Multiplication 0 × 3"); // 0 * 3 = 0 (0000)
        testMultiplication(3, new State[]{State.True, State.True, State.True, State.False, State.True, State.True}, "Multiplication 7 × 3"); // 7 * 3 = 21 (10101)
