...
public class Main16 {
    public static void main(String[] args) {
        ...
        Probe probe1 = new Probe("probe1", 3, 3);
        Probe probe2 = new Probe("probe2", 4, 4);
        ...
        Fil fil5 = new Fil("fil5", transistor1 , probe1 , 0, 0);
        Fil fil6 = new Fil("fil5", transistor2 , probe2 , 0, 0);
                                                                              
        circuit.addComposant(rom);
        circuit.addComposant(transistor1);
        circuit.addComposant(transistor2);
        circuit.addComposant(probe1);
        circuit.addComposant(probe2);
