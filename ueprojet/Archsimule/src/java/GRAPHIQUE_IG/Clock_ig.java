...
public class Clock_ig extends AbstractComponent {
    ...
    public Clock_ig() {
        ...
        Clock clockLogique = new Clock("CLOCK#" + System.currentTimeMillis(), getX(), getY(), diameter);
    ...
    protected void paintComponent(Graphics g) {
        ...
        double hourAngle = Math.toRadians(30);  // Par exemple, 30° pour simuler 1h, à adapter
        ...
        double minuteAngle = Math.toRadians(120); // Par exemple, 90° pour simuler 15 minutes, à adapter
