...
public class BUFFER_ig extends AbstractComponent {
    ...
    public BUFFER_ig() {
        ...
        setOpaque(false); // Rendre le fond transparent
         ...
         Logique.gates.Buffer bufferLogique= new Logique.gates.Buffer("BUFFER"+System.currentTimeMillis(),getX(),getY());
    ...
    protected void paintComponent(Graphics g) {
        ...
        //  Entrée (ligne à gauche)
        g2.drawLine(x - 20, y + h / 2, x, y + h / 2);

        // Sortie (ligne à droite)
 ...
 // initialisation par defaut 
    private java.util.List<Logique.Principale.State> inputStates = java.util.Arrays.asList(Logique.Principale.State.UNKNOWN) ;
