...
import Logique.gates.ControlledInverter;
...
public class Controlled_inverter_ig extends AbstractComponent {

    public Controlled_inverter_ig() {
        super("Controlled Inverter", 2, 1);
        setOpaque(false);
        setPreferredSize(new Dimension( 90, 60));

        ControlledInverter Controlled_inverter_logique = new ControlledInverter("Controlled_inverter#" + System.currentTimeMillis(), getX(), getY());
        setComposant(Controlled_inverter_logique);
    }
