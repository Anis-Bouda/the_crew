...
public class ROM_ig extends AbstractComponent3 {
    ...
    private java.util.List<State> inputStates = new java.util.ArrayList<>(java.util.Collections.nCopies(3, State.UNKNOWN));
    private java.util.List<State> outputStates = new java.util.ArrayList<>(java.util.Collections.nCopies(4, State.UNKNOWN));
