...
import Logique.Memory.BasculeJK;
...
public class BJK_ig extends AbstractComponent6 {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                for (java.awt.Point port : getInputPorts()) {
                    if (port.distance(clickPoint) < 10) {
                        System.out.println("Port d'entrée Bascule JK sélectionné !");
                    }
                }
                for (java.awt.Point port : getOutputPorts()) {
                    if (port.distance(clickPoint) < 10) {
                        System.out.println(" Port de sortie Bascule JK sélectionné !");
                    }
                }
            }
        });
    ...
    protected void paintComponent(Graphics g) {
     ...
     // Dessiner un cercle vide de diamètre 20 centré à (x, y - headerHeight + 65)
        ...
        g2.drawLine(x+20, y - headerHeight + 40, x , y - headerHeight + 40); // Entrée 2
 ...
 // initialisation par defaut 
    private java.util.List<Logique.Principale.State> inputStates = java.util.Arrays.asList(Logique.Principale.State.UNKNOWN, Logique.Principale.State.UNKNOWN, Logique.Principale.State.UNKNOWN);
