...
public class CMPT_ig extends AbstractComponent4 {
    ...
    public CMPT_ig() {
        ...
        /*la création de la porte logique pour le liens  */
         Counter compteurlogique = new Counter("COUNTER",2, getX(), getY());
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                for (java.awt.Point port : getInputPorts()) {
                    if (port.distance(clickPoint) < 10) {
                        System.out.println(" Port d'entrée CMPT sélectionné !");
                    }
                }
                for (java.awt.Point port : getOutputPorts()) {
                    if (port.distance(clickPoint) < 10) {
                        System.out.println("Port de sortie CMPT sélectionné !");
                    }
                }
            }
        });
   ...
   @Override
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawLine(x+200, y - headerHeight + 70, x + 220, y - headerHeight + 70); 
