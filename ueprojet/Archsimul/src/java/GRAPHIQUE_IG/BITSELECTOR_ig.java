...
import Logique.plexers.ByteSelctor;
...
public class BITSELECTOR_ig extends AbstractComponent {
    ...
    public BITSELECTOR_ig() {
        ...
        ByteSelctor BitAlogique= new ByteSelctor("bitSELECTOR#"+System.currentTimeMillis(), getX(), getY());
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                for (java.awt.Point port : getInputPorts()) {
                    if (port.distance(clickPoint) < 10) {
                        System.out.println("Port d'entrée BIT SELECTOR sélectionné !");
                    }
                }
                for (java.awt.Point port : getOutputPorts()) {
                    if (port.distance(clickPoint) < 10) {
                        System.out.println(" Port de sortie BIT SELECTOR sélectionné !");
                    }
                }
            }
        });
    ...
    private java.util.List<Logique.Principale.State> inputStates = java.util.Arrays.asList(Logique.Principale.State.UNKNOWN, Logique.Principale.State.UNKNOWN, Logique.Principale.State.UNKNOWN, Logique.Principale.State.UNKNOWN, Logique.Principale.State.UNKNOWN,  Logique.Principale.State.UNKNOWN,  Logique.Principale.State.UNKNOWN,  Logique.Principale.State.UNKNOWN) ;
