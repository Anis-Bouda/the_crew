...
import Logique.Memory.BasculeSR;

public class BRS_ig extends AbstractComponent6 {
    ...
    public BRS_ig() {
        ...
        BasculeSR bsSRLogique=new BasculeSR("BASCULERS#"+System.currentTimeMillis(), getX(), getY());
        setComposant(bsSRLogique);
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                for (java.awt.Point port : getInputPorts()) {
                    if (port.distance(clickPoint) < 10) {
                        System.out.println(" Port d'entrée BRS sélectionné !");
                    }
                }
                for (java.awt.Point port : getOutputPorts()) {
                    if (port.distance(clickPoint) < 10) {
                        System.out.println("Port de sortie BRS sélectionné !");
                    }
                }
            }
        });
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawString("S", x + 30, y - headerHeight + 30);
        g2.drawString("R", x + 30, y - headerHeight + 70);
        ...
        g2.drawString("R", x + 55, y - headerHeight + 30);
        g2.drawString("S", x + 55, y - headerHeight + 85);
