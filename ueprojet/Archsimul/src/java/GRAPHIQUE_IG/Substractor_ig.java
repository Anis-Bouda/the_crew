...
public class Substractor_ig extends AbstractComponent {
    private final int width = 40;
    private final int height = 40;
    private final int offsetY = 5;

    public Substractor_ig() {
        super("SUB", 4, 3);
        setOpaque(false);

        /*la création de la porte logique pour le liens  */
         SUB sublogic= new SUB("SUB"+System.currentTimeMillis(),2,getX(),getY());
        setComposant(sublogic);
