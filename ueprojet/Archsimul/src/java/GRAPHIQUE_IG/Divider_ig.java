...
import Logique.Arithmetics.DIVIDER;
...
public class Divider_ig extends AbstractComponent {
    ...
    public Divider_ig() {
        ...
        DIVIDER divlogic=new DIVIDER("DIVIDER"+System.currentTimeMillis(),2, getX(), getY());
        setComposant(divlogic);
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Sortie
        g2.drawLine(x + w, y + (int)(0.1 * h), x + w + 29, y + (int)(0.1 * h)); 
        g2.drawLine(x + w, y + (int)(0.4 * h), x + w + 29, y + (int)(0.4 * h));
        g2.drawLine(x + w, y + (int)(0.7 * h), x + w + 29, y + (int)(0.7 * h)); 
        g2.drawLine(x + w, y + (int)(1 * h), x + w + 29, y + (int)(1 * h));
