...
import Logique.Arithmetics.COMPARATOR;

public class Comparator_ig extends AbstractComponent {
    private final int width = 40;
    private final int height = 40;
    private final int offsetY = 5;

    public Comparator_ig() {
        super("Comparator", 4, 3);
        setOpaque(false);

         /*la création de la porte logique pour le liens  */
        COMPARATOR Comparateurlogique = new COMPARATOR("Comparator"+System.currentTimeMillis(), 2, getX(), getY());
