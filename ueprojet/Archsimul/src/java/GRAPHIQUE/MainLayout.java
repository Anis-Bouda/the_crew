...
public class MainLayout extends JPanel {
 ...
 propertiesPanel.updateProperties(newComp.getX(), newComp.getY(), newComp.getComponentName());	
        ...
        circuitDesignArea.setTransferHandler(new TransferHandler() {
            ...
            public boolean importData(TransferHandler.TransferSupport support) {
                ...
                try {
                    ...
                    default:
                       // int index = extractIndexFromFileName(componentName);
                        ...
                        if (componentName.startsWith("saved_circuit_")) {
                            ...
                            // Recherche du fichier XML dans les dossiers 1, 2 et 3 entrées
                            String xmlPath = null;
                            for (int i = 1; i <= 3; i++) {
                    ...
                    try {
                        // on charge le son depuis le classpath
                        AudioInputStream ais = AudioSystem.getAudioInputStream(
                            getClass().getResourceAsStream("/sounds/plop.wav")
                        );
                        Clip clip = AudioSystem.getClip();
                        clip.open(ais);
                        clip.setMicrosecondPosition(800 * 1_000L);
                        clip.start();
                    } catch (Exception ex) {
                        ex.printStackTrace();
                    }
    ...
    private ImageIcon getComponentIcon(String componentName) {
        ...
        case "NOT":
            ...
            case "Tunnel":
                ...
                break;
            case "BitSelector":
                icon = new ImageIcon(getClass().getResource("/icons2/bitSelector.png"));
                break;
            case "Controlled_Buffer":
                icon = new ImageIcon(getClass().getResource("/icons2/ControlledBuffer.png"));
                break;
            case "Controlled_Inverter":
                icon = new ImageIcon(getClass().getResource("/icons2/ControlledInverter.png"));
                break;
            case "encodeur":
                icon = new ImageIcon(getClass().getResource("/icons2/encodeur.jpg"));
                break;
            case "Lampe":
                icon = new ImageIcon(getClass().getResource("/icons2/Lampe.png"));
                break;
            case "Splitter":
                icon = new ImageIcon(getClass().getResource("/icons2/splitter.png"));
                break;
            case "Transistor":
                icon = new ImageIcon(getClass().getResource("/icons2/Transistor.png"));
                break;
            case "Clock":
                icon = new ImageIcon(getClass().getResource("/icons2/clock.png"));
                break;
            case "Generator_ON_OFF":
                icon = new ImageIcon(getClass().getResource("/icons2/generatorOn.png"));
                break;
            case "Generator_Determinate":
                icon = new ImageIcon(getClass().getResource("/icons2/generatorDET.png"));
                break;
            case "Power":
                icon = new ImageIcon(getClass().getResource("/icons2/POWER.png"));
                break;
            case "Ground":
                icon = new ImageIcon(getClass().getResource("/icons2/ground.png"));
                break;
            case "lampe_state":
                icon = new ImageIcon(getClass().getResource("/icons2/Lampe_ON.png"));
                break;
            case "Bus Register":
    ...
    public JMenuBar createMenuBar() {
        ...
        /*nuage d'aide */
        mnuOpenFile.setToolTipText("Cliquez ici pour ouvrir une session déjà existant");
        ...
        /*nuage d'aide */
        mnuSaveFile.setToolTipText("Cliquez ici pour sauvegarder un fichier");
     ...
     // Sauvegarde/chargement de session
        ...
        /*nuage d'aide */
        mnuSaveSession.setToolTipText("Cliquez ici pour sauvegarder une session");
        ...
        /*nuage d'aide */
        mnuLoadSession.setToolTipText("Cliquez ici pour charger une session");
        ...
        /*nuage d'aide */
        mnuSaveComponent.setToolTipText("Cliquez ici pour créer un composant");
    ...
    private void saveCustomComponent() {
        ...
        //  Sélection d’une icône : trois cas
        ...
        //  Enregistrement XML dans custom_components{n}
        ...
        //  Instanciation et ajout dans le circuit (inchangé)
    ...
    static {
        ...
        ICON_PATHS.put("BitSelector",       "/icons2/bitSelector.png");
        ICON_PATHS.put("ControlledBuffer",       "/icons2/controlledBuffer.png");
        ICON_PATHS.put("ControlledInverter",       "/icons2/controlledInverter.png");
        ICON_PATHS.put("encodeur",       "/icons2/encodeur.png");
        ICON_PATHS.put("lampe",       "/icons2/Lampe.png");
        ICON_PATHS.put("splitter",       "/icons2/splitter.png");
        ICON_PATHS.put("Transistor",       "/icons2/Transistor.png");
    }
