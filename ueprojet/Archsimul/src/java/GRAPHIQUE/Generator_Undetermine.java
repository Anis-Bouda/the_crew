...
public class Generator_Undetermine extends AbstractComponent {
    ...
    public Generator_Undetermine() {
        ...
        setOpaque(false);
        updateOutputState();
        RandomGenerator rndgenLogique = new RandomGenerator("RANDOMGENERATOR#", 1,getX(), getY(), StateMapper.toLogicState(State.NORMAL));
        //RandomGenerator.setInputs(0, State.TRUE)
        setComposant(rndgenLogique);
        //updateOutputState();
    }
